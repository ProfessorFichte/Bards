...
public class BardRecipeProvider extends FabricRecipeProvider {
    ...
    public BardRecipeProvider(FabricDataOutput output) {
        super(output);
    }
    ...
    public void generate(Consumer<RecipeJsonProvider> exporter) {
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.COMBAT, (Item) Armors.entertainerArmorSet.armorSet().head)
                ...
                .offerTo(exporter, new Identifier(Armors.entertainerArmorSet.armorSet().head.toString()));
        ShapedRecipeJsonBuilder.create(RecipeCategory.COMBAT, (Item) Armors.troubadourArmorSet.armorSet().head)
                ...
                .offerTo(exporter, new Identifier(Armors.troubadourArmorSet.armorSet().head.toString()));
        //CHESTS
        ShapedRecipeJsonBuilder.create(RecipeCategory.COMBAT, (Item) Armors.entertainerArmorSet.armorSet().chest)
                ...
                .offerTo(exporter, new Identifier(Armors.entertainerArmorSet.armorSet().chest.toString()));
        ShapedRecipeJsonBuilder.create(RecipeCategory.COMBAT, (Item) Armors.troubadourArmorSet.armorSet().chest)
                ...
                .input('C', Items.GOLD_INGOT)
                .criterion(hasItem(Items.RABBIT_HIDE), conditionsFromItem(Items.RABBIT_HIDE))
                .offerTo(exporter, new Identifier(Armors.troubadourArmorSet.armorSet().chest.toString()));
        //LEGS
        ShapedRecipeJsonBuilder.create(RecipeCategory.COMBAT, (Item) Armors.entertainerArmorSet.armorSet().legs)
                ...
                .input('C', Items.PURPLE_DYE)
                .criterion(hasItem(Items.LEATHER), conditionsFromItem(Items.LEATHER))
                .offerTo(exporter, new Identifier(Armors.entertainerArmorSet.armorSet().legs.toString()));
        ShapedRecipeJsonBuilder.create(RecipeCategory.COMBAT, (Item) Armors.troubadourArmorSet.armorSet().legs)
                ...
                .input('C', Items.GOLD_INGOT)
                .criterion(hasItem(Items.RABBIT_HIDE), conditionsFromItem(Items.RABBIT_HIDE))
                .offerTo(exporter, new Identifier(Armors.troubadourArmorSet.armorSet().legs.toString()));
        //FEET
        ShapedRecipeJsonBuilder.create(RecipeCategory.COMBAT, (Item) Armors.entertainerArmorSet.armorSet().feet)
                ...
                .input('C', Items.PURPLE_DYE)
                .criterion(hasItem(Items.LEATHER), conditionsFromItem(Items.LEATHER))
                .offerTo(exporter, new Identifier(Armors.entertainerArmorSet.armorSet().feet.toString()));
        ShapedRecipeJsonBuilder.create(RecipeCategory.COMBAT, (Item) Armors.troubadourArmorSet.armorSet().feet)
                ...
                .criterion(hasItem(Items.RABBIT_HIDE), conditionsFromItem(Items.RABBIT_HIDE))
                .offerTo(exporter, new Identifier(Armors.troubadourArmorSet.armorSet().feet.toString()));
    }
    ...
    private void createConditionalShapedRecipe(Consumer<RecipeJsonProvider> exporter, String name, RecipeCategory category,
        ...
        var conditionalExporter = withConditions(exporter, DefaultResourceConditions.allModsLoaded(requiredMod));

        Item result = getOrFallback(new Identifier(resultId), Items.BARRIER);
        Item ingredient = getOrFallback(new Identifier(ingredientId), Items.NETHERITE_INGOT);
        Item ingredient2 = getOrFallback(new Identifier(ingredientId2), Items.AMETHYST_SHARD);
