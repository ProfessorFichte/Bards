...
public class SpellthiefImpact implements SpellHandlers.CustomImpact {
    ...
    public SpellHandlers.ImpactResult onSpellImpact(
            ...
            for (StatusEffectInstance effect : beneficialEffects) {
                ...
                if (effectId != null) {
                    serverWorld.spawnParticles(
                        new PopupParticleEffect(BardParticles.SPELL_STOLEN_POPUP, effectId, false, caster.getId()),
        ...
        if (caster.getWorld() instanceof ServerWorld serverWorld) {
            serverWorld.spawnParticles(
                new PopupParticleEffect(BardParticles.SPELL_STOLEN_POPUP, spellId, true, caster.getId()),
