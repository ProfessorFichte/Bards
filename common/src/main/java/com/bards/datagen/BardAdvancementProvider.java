...
public class BardAdvancementProvider implements DataProvider {
    ...
    static {
        ...
        addEntry(new Entry(
                ...
                "The Motivator",
                "Complete the Bard's Stories Book!",
                id("spell_novice_bard"),
                MOD_ID + ":netherite_lute",
