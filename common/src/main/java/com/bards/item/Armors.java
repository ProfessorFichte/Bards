...
public class Armors {
    ...
    public static ArmorMaterial entertainers_garb = material(
            "entertainers_garb",
            1, 3, 2, 1,
            9,
            SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, () -> { return Ingredient.fromTag(ItemTags.WOOL); });

    public static ArmorMaterial troubadours_garb = material(
            "troubadours_garb",
            1, 3, 2, 1,
            10,
            SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, () -> { return Ingredient.fromTag(ItemTags.WOOL); });

    public static ArmorMaterial netherite_troubadours_garb = material(
            "netherite_troubadours_garb",
            1, 3, 2, 1,
            15,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, () -> { return Ingredient.ofItems(Items.NETHERITE_INGOT); });
    public static ArmorMaterial storytellers_garb = material(
            "storytellers_garb",
            1, 3, 2, 1,
            18,
    ...
    public static final Armor.Entry entertainerArmorSet = create(
            ...
            ArmorSetConfig.with(
                    new ArmorSetConfig.Piece(entertainers_garb.getProtection(ArmorItem.Type.HELMET))
                    ...
                    new ArmorSetConfig.Piece(entertainers_garb.getProtection(ArmorItem.Type.CHESTPLATE))
                            .add(AttributeModifier.multiply(SpellSchools.ARCANE.id, bard_spell_power_t1))
                            .add(AttributeModifier.multiply(SpellSchools.HEALING.id, bard_spell_power_t1))
                            .add(movementSpeed(bard_speed_T1)),
                    new ArmorSetConfig.Piece(entertainers_garb.getProtection(ArmorItem.Type.LEGGINGS))
                            .add(AttributeModifier.multiply(SpellSchools.ARCANE.id, bard_spell_power_t1))
                            .add(AttributeModifier.multiply(SpellSchools.HEALING.id, bard_spell_power_t1))
                            .add(movementSpeed(bard_speed_T1)),
                    new ArmorSetConfig.Piece(entertainers_garb.getProtection(ArmorItem.Type.BOOTS))
                            .add(AttributeModifier.multiply(SpellSchools.ARCANE.id, bard_spell_power_t1))
                            .add(AttributeModifier.multiply(SpellSchools.HEALING.id, bard_spell_power_t1))
                            .add(movementSpeed(bard_speed_T1))
            ),
    ...
    public static final Armor.Entry troubadourArmorSet = create(
            ...
            Armor.CustomItem::new,
            ArmorSetConfig.with(
                    new ArmorSetConfig.Piece(troubadours_garb.getProtection(ArmorItem.Type.HELMET))
                    ...
                    new ArmorSetConfig.Piece(troubadours_garb.getProtection(ArmorItem.Type.CHESTPLATE))
                            .add(AttributeModifier.multiply(SpellSchools.ARCANE.id, bard_spell_power_t2))
                            .add(AttributeModifier.multiply(SpellSchools.HEALING.id, bard_spell_power_t2))
                            .add(movementSpeed(bard_speed_T2)),
                    new ArmorSetConfig.Piece(troubadours_garb.getProtection(ArmorItem.Type.LEGGINGS))
                            .add(AttributeModifier.multiply(SpellSchools.ARCANE.id, bard_spell_power_t2))
                            .add(AttributeModifier.multiply(SpellSchools.HEALING.id, bard_spell_power_t2))
                            .add(movementSpeed(bard_speed_T2)),
                    new ArmorSetConfig.Piece(troubadours_garb.getProtection(ArmorItem.Type.BOOTS))
                            .add(AttributeModifier.multiply(SpellSchools.ARCANE.id, bard_spell_power_t2))
                            .add(AttributeModifier.multiply(SpellSchools.HEALING.id, bard_spell_power_t2))
                            .add(movementSpeed(bard_speed_T2))
            ),
    ...
    public static final Armor.Entry netheriteTroubadourArmorSet = create(
            ...
            Armor.CustomItem::new,
            ArmorSetConfig.with(
                    new ArmorSetConfig.Piece(netherite_troubadours_garb.getProtection(ArmorItem.Type.HELMET))
                    ...
                    new ArmorSetConfig.Piece(netherite_troubadours_garb.getProtection(ArmorItem.Type.CHESTPLATE))
                            .add(AttributeModifier.multiply(SpellSchools.ARCANE.id, bard_spell_power_t3))
                            .add(AttributeModifier.multiply(SpellSchools.HEALING.id, bard_spell_power_t3))
                            .add(movementSpeed(bard_speed_T3)),
                    new ArmorSetConfig.Piece(netherite_troubadours_garb.getProtection(ArmorItem.Type.LEGGINGS))
                            .add(AttributeModifier.multiply(SpellSchools.ARCANE.id, bard_spell_power_t3))
                            .add(AttributeModifier.multiply(SpellSchools.HEALING.id, bard_spell_power_t3))
                            .add(movementSpeed(bard_speed_T3)),
                    new ArmorSetConfig.Piece(netherite_troubadours_garb.getProtection(ArmorItem.Type.BOOTS))
                            .add(AttributeModifier.multiply(SpellSchools.ARCANE.id, bard_spell_power_t3))
                            .add(AttributeModifier.multiply(SpellSchools.HEALING.id, bard_spell_power_t3))
                            .add(movementSpeed(bard_speed_T3))
            ),
